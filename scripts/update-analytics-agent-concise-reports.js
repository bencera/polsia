...
/**
 * Update Analytics Agent to generate concise daily reports instead of comprehensive ones
 */
...
async function updateAnalyticsAgentRole() {
    ...
    try {
        console.log('Updating Analytics Agent role for concise daily reports...\n');
...
After collecting metrics, create a **concise daily snapshot report**:

**Report Format:**
- Report title with date
- 5-10 key metrics in a clean format (tables or lists)
- 2-3 sentence summary of notable changes or trends
- 1-2 action items if anything requires attention

**Keep it short and factual:**
- Focus on TODAY's numbers with comparisons to recent periods (7d, 30d)
- Use bullet points and tables for clarity
- Skip lengthy explanations - let the numbers speak
- Only highlight significant changes (>20% change or critical issues)
- Aim for ~200-400 words total

**What NOT to include:**
- Long executive summaries
- Detailed trend analysis (save for weekly/monthly reports)
- Extensive historical comparisons
- Multiple paragraphs per metric

4. Save the report using the Reports MCP with report_type="render_analytics"
...
- Keep reports concise and scannable - this is a daily snapshot, not a comprehensive analysis
- Compare current metrics to historical trends when possible`;
        ...
        console.log('\n✅ Agent role updated for concise daily reports!');
