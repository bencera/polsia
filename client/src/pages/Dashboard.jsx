    ...
    <>
              ...
              <>
                ...
                <div style={{marginTop: '10px'}}>
                  <a
                    onClick={() => {
                      if (isPublic) {
                        setIsPublicConnectionsModalOpen(true);
                      } else {
      ...
      {isPublicConnectionsModalOpen && (
        <div
          ...
          onClick={() => setIsPublicConnectionsModalOpen(false)}
        >
          <div
            style={{
              backgroundColor: '#fff',
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <h2 style={{ margin: 0, fontFamily: 'Times New Roman, Times, serif' }}>Service Connections</h2>
              <button
                onClick={() => setIsPublicConnectionsModalOpen(false)}
                className="dashboard-btn"
              >
            ...
            <div style={{ fontFamily: 'Times New Roman, Times, serif', fontSize: '14px', lineHeight: '1.8' }}>
              <p style={{ marginBottom: '20px' }}>
                This company is connected to various services (GitHub, Gmail, Render, etc.) to enable Polsia to autonomously run operations.
              </p>
              <p style={{ marginBottom: '20px' }}>
                <strong>Connection management is reserved to the owner of the project.</strong> Only the owner can add, remove, or reconfigure service connections.
              </p>
              <p style={{ marginBottom: '0', fontSize: '13px', color: '#666' }}>
                These connections allow the autonomous system to access external APIs, manage repositories, send emails, deploy services, and perform other tasks on behalf of the company.
              </p>
            </div>
          </div>
        </div>
